		...
		unsigned int intr_count)
{
	...
	rmi4_data->temp_report_data = kzalloc(array3_size(4, rmi4_data->num_of_tx, rmi4_data->num_of_rx),
					      GFP_KERNEL);
	rmi4_data->report_data = kzalloc(array3_size(4, rmi4_data->num_of_tx, rmi4_data->num_of_rx),
					 GFP_KERNEL);
